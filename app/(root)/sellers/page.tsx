	...
	return (
		<div className='flex flex-col flex-1 justify-center items-center min-h-screen mt-28'>
			<div className='flex flex-col flex-1 justify-center items-center w-full max-w-lg gap-5'>
				...
				<div>
					<p>
						With a deep understanding of the real estate landscape, we provide
						insights and guidance, helping you navigate negotiations, paperwork,
						and every detail until the closing day.
					</p>
				</div>
