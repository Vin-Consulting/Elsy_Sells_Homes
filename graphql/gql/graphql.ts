...
export type DeleteListingMutationVariables = Exact<{
  deleteListingId: Scalars['Float']['input'];
}>;
...
export type DeleteVideoMutationVariables = Exact<{
  deleteVideoId: Scalars['Float']['input'];
}>;
...
export const DeleteVideoDocument = gql`
  mutation DeleteVideo($deleteVideoId: Float!) {
    deleteVideo(id: $deleteVideoId)
  }
`;

export function useDeleteVideoMutation() {
  return Urql.useMutation<DeleteVideoMutation, DeleteVideoMutationVariables>(
    DeleteVideoDocument
  );
}
...
export function useGetArticlesQuery(
  ...
  return Urql.useQuery<GetArticlesQuery, GetArticlesQueryVariables>({
...
export function useGetListingsQuery(
  options?: Omit<Urql.UseQueryArgs<GetListingsQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetListingsQuery, GetListingsQueryVariables>({
...
export function useGetVideosQuery(
  ...
  return Urql.useQuery<GetVideosQuery, GetVideosQueryVariables>({
